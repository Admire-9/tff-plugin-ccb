...
import com.example.entity.BusInfoEntity;
...
public class Url {
  ...
  public String POSID = "912817341"; //商户柜台代码
  public String BRANCHID = "361100000"; //分行代码
...
//  public String GATEWAY = "UnionPay";
  ...
  public String make(BusInfoEntity busInfo, String price, String ip) {
    String tmp;
    String tmp0;
